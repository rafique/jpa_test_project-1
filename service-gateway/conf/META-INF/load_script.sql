...
insert into car (car_id, license_plate, seat_count, convertible, rating, manufacturer) values ('1', 'licenseplate1', 10, false,1, 'carmanifacturer1');
insert into car (car_id, license_plate, seat_count, convertible, rating, manufacturer) values ('2', 'licenseplate2', 20, false,2, 'carmanifacturer2');
insert into car (car_id, license_plate, seat_count, convertible, rating, manufacturer) values ('3', 'licenseplate3', 30, false,3, 'carmanifacturer3');
